    ...
    return(
        <div>
            ...
            <div className="about">
                ...
                <ul>
                    <li>Task-Based Earnings: From completing surveys and writing reviews to testing new apps and websites, Campus Flux provides a wide range of online tasks that are both engaging and profitable.</li>
                    <li>Referral Programs: Maximize your earnings by inviting friends to join Campus Flux. Our referral program rewards you for every friend who signs up and starts earning.</li>
                    <li>Community Support: Join a vibrant community of like-minded individuals who share tips, offer support, and celebrate each other's successes.</li>
                    <li>Flexible Opportunities: Work at your own pace and choose tasks that fit your schedule. Whether you have a few minutes or a few hours, Campus Flux has opportunities for you.</li>
                </ul>
                </div>
                <div><h2>Why Choose Campus Flux?</h2>
                <ul>
                    <li>User-Friendly Platform: Our intuitive design makes it easy for you to find and complete tasks, track your earnings, and manage your referrals.</li>
                    <li>
